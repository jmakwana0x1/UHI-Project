...
contract MinimalSubscriber5 is AbstractReactive {
    ...
    constructor() payable {
        if (!vm) {
            // Mirror MatchingRSC: 3 topics × 2 chains
            ...
            // + cron, exact demo pattern
            service.subscribe(block.chainid, address(service), CRON_10, ANY, ANY, ANY);
        }
    }
